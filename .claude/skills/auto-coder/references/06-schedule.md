...
|---------|---------|------|---------|------|
| A1 | 初始化目录树与最小可运行入口 | [x] | 2026-03-29 | 完成：目录树/main.py/settings.yaml/prompt templates |
| A2 | 引入 pytest 并建立测试目录约定 | [x] | 2026-03-29 | 完成：pytest配置/test_smoke_imports.py/测试目录 |
| A3 | 配置加载与校验（Settings） | [x] | 2026-03-29 | 完成：Settings/load_settings/validate_settings |

#### 阶段 B：Libs 可插拔层

| 任务编号 | 任务名称 | 状态 | 完成日期 | 备注 |
|---------|---------|------|---------|------|
| B1 | LLM 抽象接口与工厂 | [x] | 2026-03-29 | 完成：BaseLLM/FakeLLM/LLMFactory + 18个单元测试 |
